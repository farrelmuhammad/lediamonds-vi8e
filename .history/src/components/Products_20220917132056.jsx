        ...
        >
          <div class="d-flex flex-lg-row flex-column align-items-center">
            ...
            <div class="img-hero text-center justify-content-center d-flex">
              ...
              <ol class="p-0 m-0">
                <li style={{ marginBottom: "1rem" }} aria-level="1">
                  <p class="text-caption">
                    Pilih jawaban yang menggambarkan kondisi kamu sebenarnya.
                ...
                <li style={{ marginBottom: "1rem" }} aria-level="1">
                  <p class="text-caption">
                    Pengerjaan tes tidak dibatasi waktu sehingga kamu dapat
                    <br class="d-sm-inline d-none" />
                ...
                <li style={{ marginBottom: "1rem" }} aria-level="1">
                  <p class="text-caption">
                    Cari tempat yang nyaman dan kondusif selama mengerjakan tes{" "}
                    <br class="d-sm-inline d-none" />
                ...
                <li style={{ marginBottom: "1rem" }} aria-level="1">
                  <p class="text-caption">
                    Jika keluar, maka seluruh proses tes dan jawaban akan
                    hilang.
                    <br class="d-sm-inline d-none" />
                ...
                <li style={{ marginBottom: "1rem" }} aria-level="1">
                  <p class="text-caption">
                    Setelah semua pertanyaan diisi dengan lengkap, hasil akan{" "}
                    <br class="d-sm-inline d-none" />
          ...
          <div class="right-column d-flex flex-column align-items-lg-start align-items-center text-lg-start text-center">
            <img id="hero" class="img-fluid" src="./img/img-hero2.png" alt="" />
          </div>
        </div>
      </section>
    </>
