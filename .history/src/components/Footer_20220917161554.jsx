          ...
          <div class="row">
            <div class="col p-0 mt-4">
              <div className="text-footer text-start mt-3">
                ...
                <p className="pe-5">With Le Diamonds, we hope to empower and inspire women of all ages, giving them the courage and confidence to power through each day with their choice of elegant and charming contemporary jewellery.</p>
                <img src={Debit} alt="" />
              </div>
            </div>
            <div class="col mt-5">
