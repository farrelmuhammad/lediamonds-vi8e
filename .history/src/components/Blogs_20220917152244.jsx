      ...
      <div class="d-flex flex-row justify-content-center mb-3">
        <div class="p-2 bd-highlight">
          <div class="card" style={{ width: "18rem" }}>
            ...
            <div class="card-body">
              <h6 class="card-title">CAN MOISSANITE BE YOUR NEXT ‘SUPERSTAR’ JEWELRY STONE?</h6>
              <p class="card-text">
        ...
        <div class="p-2 bd-highlight">
          <div class="card" style={{ width: "18rem" }}>
            ...
            <div class="card-body">
              <h6 class="card-title">IS MOISSANITE MORE VALUABLE THAN A DIAMOND?</h6>
              <p class="card-text">
        ...
        <div class="p-2 bd-highlight">
          <div class="card" style={{ width: "18rem" }}>
            ...
            <div class="card-body">
              <h6 class="card-title">ENGAGEMENT RING MOISSANITE SINGAPORE BUYING GUIDE</h6>
              <p class="card-text">
                Some quick example text to build on the card title and make up
                the bulk of the card's content.
              </p>
