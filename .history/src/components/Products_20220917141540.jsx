  ...
  return (
    <section id="about" class="about section-bg">
      <div class="container" data-aos="fade-up">
        <div class="row ms-5 p-5 justify-content-center">
          <div
            class="col-lg-6 pt-4 pt-lg-0 content d-flex flex-column justify-content-center text-product"
            data-aos="fade-up"
            data-aos-delay="100"
          >
            <h5>Luxury Defined By Style, Not Price.</h5>
